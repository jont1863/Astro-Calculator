 ...
 var planets = [ 
    ...
    //First intialize the dropDown options so it takes the options from the array planets.
...
function calculateWeight(weight, planetName) { 
    ...
    if (planet) {
        let newWeight = weight * planet[1];
        return newWeight;
        //document.getElementById('output').testContext = `If you were on ${planetName}, you would weigh ${newWeight} lbs.`;
    } else {
